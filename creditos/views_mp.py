...
class PreferenceNew(generic.View):
	...
	def post(self, request):
		...
		try:
			costo_mp = 1.0569093 if not club(request).costo_mp else 1
			...
			preference = Preference.objects.create(
				...
				description='',
				account=club(request).mercado_pago,
...
class MPPending(generic.View):
	...
	""" Al recibir una preferencia que está pendiente desde mercadopago """
