...
def cons_index(request):
	...
	clubes = Club.objects.all().order_by('-id')[:5]

	return render(request, 'superusuario/clubes/index.html', locals())
...
def cons_registro(request):
	...
	return render(request, 'superusuario/clubes/registro.html', locals())
...
def cons_nuevo_1(request, cont=None):
	...
	return render(request, 'superusuario/clubes/nuevo.html', locals())
